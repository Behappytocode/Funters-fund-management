      ...
      <header className="bg-white border-b border-slate-200 sticky top-0 z-40 px-6 py-4 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2">
          ...
          <div className="flex flex-col">
            <h1 className="text-lg font-black tracking-tight text-slate-900 leading-tight">Funters Fund Management</h1>
            <p className="text-[9px] text-slate-400 font-black uppercase tracking-[0.1em] -mt-0.5">Friendship that Stands in Crisis</p>
          </div>
        </Link>
